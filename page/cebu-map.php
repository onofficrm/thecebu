...
<main class="cebu-map-page" data-cebu-map-page>
    ...
    <div class="cebu-map-page__layout">
        <aside class="cebu-map-page__panel">
            <section class="cebu-map-search" aria-label="세부생활지도 검색">
                <div class="cebu-map-search__head">
                ...
                <div class="cebu-map-search__row">
                    ...
                    <label class="sound_only" for="cebuMapType">카테고리</label>
                    <select id="cebuMapType" class="cebu-map-search__select" data-map-filter="type">
        ...
        <section class="cebu-map-map-panel" aria-label="세부생활지도">
            <div class="cebu-map-map-panel__canvas">
