...
(function (global) {
  ...
  function renderLanguageBadge(extraClass) {
    return ''
      + '<div class="eottae-language ' + esc(extraClass || '') + '" data-eottae-language-badge="1">'
  ...
  function renderHomeGnbShell(data) {
    ...
    return ''
      ...
      + renderLanguageBadge('eottae-language--desktop')
