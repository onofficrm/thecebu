...
<main class="community-page__main">
    ...
    <div class="community-list-admin">
        ...
        <div class="community-list-admin__actions">
            ...
            <button type="submit" name="btn_submit" value="선택복사" class="community-list-admin__btn" onclick="document.pressed=this.value">선택복사</button>
            <button type="submit" name="btn_submit" value="선택이동" class="community-list-admin__btn" onclick="document.pressed=this.value">선택이동</button>
        </div>
    </div>
    <?php } ?>
