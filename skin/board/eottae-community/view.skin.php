...
<main class="community-view-page__main">
    ...
    <article class="<?php echo $article_class; ?>">
        ...
        if (!$hide_plain_body) {
        ?>
        <section class="community-view-page__body talk-ai-msg__body<?php echo $is_ai_post ? ' talk-ai-msg__body--ai' : ''; ?><?php echo $is_icrm_view_body ? ' community-view-page__body--icrm' : ''; ?>" id="bo_v_con" data-translation-content>
