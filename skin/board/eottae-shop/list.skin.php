...
(function () {
    ...
    function goToCurrentLocation() {
        ...
        var panel = document.querySelector('[data-eottae-shop-map]');
        if (panel && panel._eottaeShopMapBound) {
            document.addEventListener('eottae:shop-maps-ready', function onReady() {
                document.removeEventListener('eottae:shop-maps-ready', onReady);
