...
if (!function_exists('eottae_builder_inject_home_public_chat')) {
    function eottae_builder_inject_home_public_chat($html)
    {
        ...
        $chat_html = eottae_public_group_chat_html(10, true);
        if ($chat_html === '') {
            return $html;
        }
...
if (!function_exists('eottae_builder_inject_head_meta_tags')) {
    function eottae_builder_inject_head_meta_tags($html)
    {
        if (!is_string($html) || $html === '') {
            return $html;
        }
...
if (!function_exists('eottae_builder_inject_html')) {
    function eottae_builder_inject_html($html, $id)
    {
        ...
        $html = eottae_builder_inject_head_meta_tags($html);
...
if (!function_exists('eottae_free_board_table')) {
    function eottae_free_board_table()
    {
        return defined('EOTTae_FREE_TABLE') ? EOTTae_FREE_TABLE : 'free';
    }
}

if (!function_exists('eottae_free_list_url')) {
    /**
     * 자유게시판 목록 (bo_table=free, 짧은주소 /free/)
     */
    function eottae_free_list_url($params = array())
    {
        $table = eottae_free_board_table();
...
if (!function_exists('eottae_community_free_list_url')) {
    ...
    {
        return eottae_free_list_url($params);
    }
}
...
if (!function_exists('eottae_gnb_board_tables')) {
    function eottae_gnb_board_tables()
    {
        ...
        $tables[] = eottae_free_board_table();
