<?php
/**
 * 웹 — 세부톡방 DB 테이블 설치 (최고관리자 전용)
 *
 * URL: /setup/tools/eottae-talkroom-install.php
 *      /setup/tools/eottae-talkroom-install.php?action=status
 *      /setup/tools/eottae-talkroom-install.php?action=rollback&confirm=1
 */
