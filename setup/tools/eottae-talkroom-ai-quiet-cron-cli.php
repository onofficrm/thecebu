 ...
 * CLI — 조용한 방 AI 화제 던지기
 *
 * 실행:   php setup/tools/eottae-talkroom-ai-quiet-cron-cli.php
 * dry-run: php setup/tools/eottae-talkroom-ai-quiet-cron-cli.php --dry-run
 * 방 지정: php setup/tools/eottae-talkroom-ai-quiet-cron-cli.php --room-id=3
 */
...
$_SERVER['REQUEST_URI'] = '/setup/tools/eottae-talkroom-ai-quiet-cron-cli.php';
$_SERVER['SCRIPT_NAME'] = '/setup/tools/eottae-talkroom-ai-quiet-cron-cli.php';
