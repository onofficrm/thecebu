<?php
/**
 * CLI — 세부톡방 AI DB 테이블 설치/상태 확인
 *
 * 설치:   php setup/tools/eottae-talkroom-ai-install-cli.php
 * 상태:   php setup/tools/eottae-talkroom-ai-install-cli.php --status
 * 롤백:   php setup/tools/eottae-talkroom-ai-install-cli.php --rollback --confirm
 */
...
$_SERVER['REQUEST_URI'] = '/setup/tools/eottae-talkroom-ai-install-cli.php';
$_SERVER['SCRIPT_NAME'] = '/setup/tools/eottae-talkroom-ai-install-cli.php';
...
if ($rollback) {
    if (!$confirm) {
        ...
        fwrite(STDERR, "  php setup/tools/eottae-talkroom-ai-install-cli.php --rollback --confirm\n");
        exit(1);
    }
