 ...
 * CLI — AI 모임 제안
 *
 * 실행:   php setup/tools/eottae-talkroom-ai-meetup-cron-cli.php
 * dry-run: php setup/tools/eottae-talkroom-ai-meetup-cron-cli.php --dry-run
 * 방 지정: php setup/tools/eottae-talkroom-ai-meetup-cron-cli.php --room-id=3
 */
...
$_SERVER['REQUEST_URI'] = '/setup/tools/eottae-talkroom-ai-meetup-cron-cli.php';
$_SERVER['SCRIPT_NAME'] = '/setup/tools/eottae-talkroom-ai-meetup-cron-cli.php';
...
$result = eottae_talkroom_ai_run_meetup_cron(array(
    'dry_run' => $dry_run,
    'room_id' => $room_id,
));

$summary = $result['summary'];
echo "=== talkroom AI meetup cron ===\n";
