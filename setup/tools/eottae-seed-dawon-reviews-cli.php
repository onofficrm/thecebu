<?php
/**
 * CLI — 다원(shop wr_id=11) 리뷰 47건 시드
 * php setup/tools/eottae-seed-dawon-reviews-cli.php
 * php setup/tools/eottae-seed-dawon-reviews-cli.php 11
 */
...
$shop_wr_id = isset($argv[1]) ? (int) $argv[1] : 11;
if ($shop_wr_id < 1) {
    fwrite(STDERR, "Usage: php setup/tools/eottae-seed-dawon-reviews-cli.php [shop_wr_id]\n");
    exit(1);
}

if (!function_exists('eottae_seed_dawon_reviews')) {
    fwrite(STDERR, "eottae_seed_dawon_reviews() missing\n");
    exit(1);
}

$logs = eottae_seed_dawon_reviews($shop_wr_id);
$inserted = 0;
$skipped = 0;
$failed = 0;
