 ...
 *
 * CLI:
 *   php cron/sebu_talk_ai_meetup.php
 *   php cron/sebu_talk_ai_meetup.php --dry-run
 *   php cron/sebu_talk_ai_meetup.php --room-id=3
 *
 * 웹 (talkroom_ai_cron_key 설정 시):
 *   /cron/sebu_talk_ai_meetup.php?key=YOUR_SECRET
 */
...
if ($is_cli) {
    ...
    $_SERVER['REQUEST_URI'] = '/cron/sebu_talk_ai_meetup.php';
    $_SERVER['SCRIPT_NAME'] = '/cron/sebu_talk_ai_meetup.php';
