...
.talk-admin-shell-root{box-sizing:border-box;min-height:100vh;padding:0;background:#eef2f7;color:#0f172a;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"Noto Sans KR",sans-serif;line-height:1.5}
...
.talk-admin-shell-root .talk-admin-filter{display:flex;flex-wrap:wrap;gap:8px;margin:14px 0 0}
.talk-admin-shell-root .talk-admin-filter__item{display:inline-flex;align-items:center;min-height:36px;padding:0 14px;border-radius:999px;font-size:13px;font-weight:700;text-decoration:none;color:#64748b;background:#fff;border:1px solid #e2e8f0}
.talk-admin-shell-root .talk-admin-filter__item.is-active{color:#0284c7;background:#f0f9ff;border-color:#7dd3fc}
.talk-admin-shell-root .promo-admin-panel{padding:0;overflow:hidden;border-radius:18px;background:#fff;border:1px solid #e2e8f0;box-shadow:0 8px 24px rgba(15,23,42,.06)}
