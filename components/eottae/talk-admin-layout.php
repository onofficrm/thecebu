...
.talk-admin-shell-root .talk-admin-applies__header .promo-admin-page__desc{margin-bottom:0}
.talk-admin-shell-root .talk-admin-applies-page .talk-admin-applies__panel{display:block!important;visibility:visible!important;opacity:1!important;min-height:160px!important;margin-top:16px!important;padding:0!important;overflow:visible!important;position:relative!important;z-index:1!important;border-radius:18px;background:#fff;border:1px solid #e2e8f0;box-shadow:0 8px 24px rgba(15,23,42,.06)}
.talk-admin-shell-root .talk-admin-applies-page .talk-admin-applies__filter,.talk-admin-shell-root .talk-admin-applies-page .talk-admin-applies__empty,.talk-admin-shell-root .talk-admin-applies-page .talk-admin-applies__summary,.talk-admin-shell-root .talk-admin-applies-page .talk-admin-table-wrap{display:block!important;float:none!important;clear:both!important;width:100%!important;visibility:visible!important;opacity:1!important}
.talk-admin-shell-root .promo-admin-page__header,.talk-admin-shell-root .talk-admin-applies__header,.talk-admin-shell-root .talk-admin-applies-page .talk-admin-applies__panel{overflow:visible!important}
